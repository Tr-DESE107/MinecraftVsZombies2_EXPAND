...
本游戏存在两个版本。过去使用Gamemaker Studio 2制作的版本更新到第四章，目前已经被废弃。而现在使用Unity制作的版本目前正处于开发阶段，未来预计会有约112个器械，64个怪物以及132个冒险关卡。
...
**器械**是你用于攻击怪物的武器，对应《植物大战僵尸》中的“植物”。
有很多不同种类的器械，如：
...
如**万圣夜**处在夜晚时间，因此无法从太阳能矿井获得额外的红石，且每一大波怪物来临时都会召唤两个石像鬼雕像，打乱你的阵型。

## 星之碎片

**星之碎片（Starshard）**是能够改变战局的资源，对应《植物大战僵尸2》中的**植物养料**。

在你击败一个发绿光的怪物后，它会掉落一个星之碎片。或者你可以通过生产星之碎片的器械来获得额外的星之碎片。
...
以下是日志文件具体的位置，Windows和安卓手机的日志位置不同。
...
- 红龙在一阶段会召唤3道龙卷风。
- 红龙在二阶段的巨型火球飞行和爆炸更快。
- 红龙在二阶段的飞空的火焰爆炸范围半径翻倍。
- 上锁的箱子喷吐的蓝图为铁盔僵尸。
- 上锁的箱子在勒索弹窗中会索要2个星之碎片。

**其他**

- 敲幽灵小游戏中，剑被麻痹的时间为3秒。
- “我是僵尸”解谜模式中，熔炉总共掉落7红石。