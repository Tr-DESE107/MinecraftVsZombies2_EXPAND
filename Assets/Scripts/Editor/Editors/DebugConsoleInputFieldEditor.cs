...
namespace TMPro.EditorUtilities
{
    ...
    [CustomEditor(typeof(DebugConsoleInputField), true)]
    public class DebugConsoleInputFieldEditor : SelectableEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_foldout.fontSettings)
            {
                ...
                {
                    DebugConsoleInputField inputField = target as DebugConsoleInputField;
                ...
                if (!m_ContentType.hasMultipleDifferentValues)
                {
                    ...
                    if (m_ContentType.enumValueIndex == (int)DebugConsoleInputField.ContentType.Standard ||
                        m_ContentType.enumValueIndex == (int)DebugConsoleInputField.ContentType.Autocorrected ||
                        m_ContentType.enumValueIndex == (int)DebugConsoleInputField.ContentType.Custom)
                    {
                        EditorGUI.BeginChangeCheck();
                        ...
                        if (EditorGUI.EndChangeCheck())
                        {
                            if (text != null)
                            {
                                if (m_LineType.enumValueIndex == (int)DebugConsoleInputField.LineType.SingleLine)
                    ...
                    if (m_ContentType.enumValueIndex == (int)DebugConsoleInputField.ContentType.Custom)
                    {
                        ...
                        if (m_CharacterValidation.enumValueIndex == (int)DebugConsoleInputField.CharacterValidation.Regex)
                        {
                            EditorGUILayout.PropertyField(m_RegexValue);
                        }
                        else if (m_CharacterValidation.enumValueIndex == (int)DebugConsoleInputField.CharacterValidation.CustomValidator)
                        {
