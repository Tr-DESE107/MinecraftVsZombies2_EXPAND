    ...
    public static class MetaXMLParser
    {
        ...
        public static AlmanacMetaList ToAlmanacMetaList(this XmlNode node, string defaultNsp)
        {
            ...
            for (int i = 0; i < node.ChildNodes.Count; i++)
            {
                ...
                {
                    categoryEntries[j] = categoryNode.ChildNodes[j].ToAlmanacMetaEntry(defaultNsp);
        ...
        public static SoundMetaList ToSoundMetaList(this XmlNode node, string defaultNsp)
        {
            ...
            {
                sounds[i] = node.ChildNodes[i].ToSoundMeta(defaultNsp);
            }
        ...
        private static EntityMetaTemplate LoadEntityTemplate(this XmlNode node, string defaultNsp, XmlNode rootNode)
        {
            ...
            node.LoadTemplatePropertiesFromNode(defaultNsp, rootNode, properties);
        ...
        private static void LoadTemplatePropertiesFromNode(this XmlNode node, string defaultNsp, XmlNode rootNode, Dictionary<string, object> target)
        {
            ...
            if (!string.IsNullOrEmpty(parent))
            {
                ...
                if (parentNode != null)
                {
                    parentNode.LoadTemplatePropertiesFromNode(defaultNsp, rootNode, target);
                }
            }
        ...
        public static EntityMetaTemplate[] LoadEntityTemplates(this XmlNode node, string defaultNsp)
        {
            ...
            for (int i = 0; i < node.ChildNodes.Count; i++)
            {
                ...
                var template = templateNode.LoadEntityTemplate(defaultNsp, node);
        ...
        public static FragmentMetaList ToFragmentMetaList(this XmlNode node)
        {
            ...
            {
                resources[i] = node.ChildNodes[i].ToFragmentMeta();
            }
        ...
        public static TalkSection ToTalkSection(this XmlNode node, string defaultNsp)
        {
            ...
            if (charactersNode != null)
            {
                ...
                for (int i = 0; i < characterChildren.Count; i++)
                {
                    ...
                    characters.Add(child.ToTalkCharacter(defaultNsp));
                }
            }
            ...
            if (sentencesNode != null)
            {
                ...
                for (int i = 0; i < sentenceChildren.Count; i++)
                {
                    ...
                    sentences.Add(child.ToTalkSentence(defaultNsp));
                }
            }
        ...
        public static TalkGroup ToTalkGroup(this XmlNode node, string defaultNsp)
        {
            ...
            for (int i = 0; i < children.Count; i++)
            {
                ...
                sections.Add(child.ToTalkSection(defaultNsp));
            }
        ...
        {
            return document["talks"].ToTalkMeta(defaultNsp);
        }
        public static TalkMeta ToTalkMeta(this XmlNode node, string defaultNsp)
        {
            ...
            {
                var child = children[i];
                meta.groups.Add(child.ToTalkGroup(defaultNsp));
            }
            return meta;
        }
        #endregion
        ...
        public static NoteMetaList ToNoteMetaList(this XmlNode node, string defaultNsp)
        {
            ...
            for (int i = 0; i < resources.Length; i++)
            {
                resources[i] = node.ChildNodes[i].ToNoteMeta(defaultNsp);
            }
        ...
        public static MapMeta ToMapMeta(XmlNode node, string defaultNsp)
        {
            ...
            {
                presets[i] = presetsNode.ChildNodes[i].ToMapPreset(defaultNsp);
            }
        ...
        public static void LoadMetaList(this ModResource resource, string metaPath, XmlDocument document, string defaultNsp)
        {
            switch (metaPath)
            {
                case "talkcharacters":
                    ...
                    break;
                case "sounds":
                    resource.SoundMetaList = document["sounds"].ToSoundMetaList(defaultNsp);
                    break;
                case "models":
                    resource.ModelMetaList = ModelMetaList.FromXmlNode(document["models"], defaultNsp);
                    break;
                case "fragments":
                    resource.FragmentMetaList = document["fragments"].ToFragmentMetaList();
                    break;
                case "difficulties":
                ...
                case "entities":
                    ...
                    break;
                case "almanac":
                    resource.AlmanacMetaList = document["almanac"].ToAlmanacMetaList(defaultNsp);
                    break;
                case "notes":
                    resource.NoteMetaList = document["notes"].ToNoteMetaList(defaultNsp);
                    break;
                case "stages":
