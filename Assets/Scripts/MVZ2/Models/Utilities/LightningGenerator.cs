...
namespace MVZ2.Models
{
    ...
    public class LightningGenerator : MonoBehaviour
    {
        ...
        {
            var points = GenerateLightning(pointCount, sourcePosition, targetPosition, amplitude, rng);
        ...
        public static Vector3[]? GenerateLightning(int pointCount, Vector3 sourcePosition, Vector3 targetPosition, float amplitude, RandomGenerator rng)
        {
            if (pointCount < 2)
            {
