...
namespace MVZ2.TalkData
{
    public class TalkScript
    {
        ...
        public TalkScript(string function, params string[] arguments)
        {
            this.function = function;
            this.arguments = arguments;
        }

        public static bool TryParse(string str, [NotNullWhen(true)] out TalkScript? script)
        {
            script = null;
            str = str.Trim(' ', ';');
            ...
            script = new TalkScript(function, arguments);
            return true;
        }
