    ...
    public partial class LevelController
    {
        ...
        private class PickaxeTooltipSource : ITooltipSource
        {
            ...
            public TooltipContent GetContent()
            {
                ...
                if (!controller.level.CanUsePickaxe())
                {
                    ...
                    {
                        error = controller.Localization._p(LogicStrings.CONTEXT_BLUEPRINT_ERROR, message);
                    }
                }
                return new TooltipContent()
                {
                    name = controller.Localization._(LogicStrings.TOOLTIP_DIG_CONTRAPTION),
                    error = error,
                    description = null
                };
            }
        ...
        private class TriggerTooltipSource : ITooltipSource
        {
            ...
            public TooltipContent GetContent()
            {
                ...
                return new TooltipContent()
                {
                    name = controller.Localization._(LogicStrings.TOOLTIP_TRIGGER_CONTRAPTION),
                    error = error,
                    description = null
                };
            }
