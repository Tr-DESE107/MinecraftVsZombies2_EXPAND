...
namespace MVZ2.UI
{
    public class LevelUIBlueprintChoose : MonoBehaviour
    {
        ...
        [SerializeField]
        GameObject choosingBlueprintRoot = null!;
        [SerializeField]
        GameObject runtimeBlueprintRoot = null!;
        [SerializeField]
        BlueprintList chosenBlueprints = null!;
        [SerializeField]
        Button viewLawnReturnButton = null!;
        [SerializeField]
        GameObject viewLawnReturnBlocker = null!;
        [SerializeField]
        GameObject artifactChoosingDialogObj = null!;
        [SerializeField]
        ArtifactChoosingDialog artifactChoosingDialog = null!;
        [SerializeField]
        MovingBlueprintList movingBlueprints = null!;
        [SerializeField]
        BlueprintChoosePanel blueprintChoosePanel = null!;
        [SerializeField]
        CommandBlockChoosePanel commandBlockChoosePanel = null!;
        [SerializeField]
        Button choosingViewAlmanacButton = null!;
        [SerializeField]
        Button choosingViewStoreButton = null!;
        [SerializeField]
        bool sideUIDisplaying = true;
        [SerializeField]
        bool blueprintChooseDisplaying;
        [SerializeField]
        GameObject artifactSlotsRoot = null!;
        [SerializeField]
        ElementListUI artifactSlotList = null!;
        [SerializeField]
        Button artifactRepickButton = null!;
    }
}
