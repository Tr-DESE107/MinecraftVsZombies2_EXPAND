...
namespace MVZ2.UI
{
    ...
    /// </summary>
    [AddComponentMenu("UI/Debug Console Input Field", 11)]
    public class DebugConsoleInputField : Selectable,
        ...
        IScrollHandler
    {
        ...
        protected DebugConsoleInputField()
        {
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (!isFocused && m_SelectionStillActive)
            {
                ...
                if (selectedObject != null && selectedObject != this.gameObject)
                {
                    ...
                    if (selectedObject.GetComponent<DebugConsoleInputField>() != null)
                        ReleaseSelection();
