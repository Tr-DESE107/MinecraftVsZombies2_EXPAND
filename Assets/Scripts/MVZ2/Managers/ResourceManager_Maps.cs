...
namespace MVZ2.Managers
{
    public partial class ResourceManager : MonoBehaviour
    {
        ...
        public MapMetaList? GetModMapMetaList(string spaceName)
        {
        ...
        #region 元素
        public MapElementMeta[] GetModMapElementMetas(string spaceName)
        {
            var metalist = GetModMapMetaList(spaceName);
            if (metalist == null)
                return Array.Empty<MapElementMeta>();
            return metalist.elements.ToArray();
        }
        #endregion
