...
namespace MVZ2Logic.Level
{
    ...
    public static class LogicLevelProps
    {
        ...
        #region 屏幕覆盖
        public static readonly PropertyMeta<Color> SCREEN_COVER = Get<Color>("screenCover");
        ...
        #region 禁止暂停
        public static readonly PropertyMeta<bool> PAUSE_DISABLED = Get<bool>("pause_disabled");
        ...
        #region 镜头旋转
        public static readonly PropertyMeta<float> CAMERA_ROTATION = Get<float>("cameraRotation");
        ...
        #region 低质音乐
        public static readonly PropertyMeta<bool> MUSIC_LOW_QUALITY = Get<bool>("musicLowQuality");
        ...
        #region 画面降级
        public static readonly PropertyMeta<bool> GRAPHICS_DOWNGRADE = Get<bool>("graphicsDowngrade");
        ...
        #region RNG
        public static readonly PropertyMeta<RandomGenerator> ARTIFACT_RNG = Get<RandomGenerator>("artifactRNG");
        ...
        #region 器械随机池
        public static readonly PropertyMeta<NamespaceID[]> RANDOM_CONTRAPTION_POOL = Get<NamespaceID[]>("random_contraption_pool");
        ...
        #region 星之碎片手持物品类型
        public static readonly PropertyMeta<NamespaceID> STARSHARD_HELD_TYPE = Get("starshard_held_type", LogicHeldTypes.starshard);
        public static NamespaceID? GetStarshardHeldType(this LevelEngine game)
        {
        ...
        public static readonly PropertyMeta<float> BOSS_SPAWN_POINTS_MULTIPLIER = Get<float>("boss_spawn_points_multiplier", 1);
