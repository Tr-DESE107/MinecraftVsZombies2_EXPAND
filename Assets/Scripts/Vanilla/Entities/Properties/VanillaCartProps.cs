...
namespace MVZ2.Vanilla.Entities
{
    ...
    {
        public static readonly PropertyMeta<NamespaceID> CART_TRIGGER_SOUND = new PropertyMeta<NamespaceID>("cartTriggerSound");
        public static readonly PropertyMeta<FrameTimer> TURN_TO_MONEY_TIMER = new PropertyMeta<FrameTimer>("turnToMoneyTimer");
