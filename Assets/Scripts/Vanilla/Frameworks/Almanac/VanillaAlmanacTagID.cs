...
namespace MVZ2.Vanilla.Almanac
{
    public static class VanillaAlmanacTagID
    {
        ...
        public static readonly NamespaceID lightLevel = Get("lightLevel");
        public static readonly NamespaceID wraithLightLevel = Get("wraithLightLevel");
