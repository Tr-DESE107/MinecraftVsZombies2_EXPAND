...
namespace MVZ2.Vanilla.Grids
{
    ...
    {
        public static readonly NamespaceID gridDisabled = Get("grid_disabled");
        public static readonly NamespaceID alreadyTaken = Get("already_taken");
        public static readonly NamespaceID outOfBounds = Get("out_of_bounds");
        ...
        public static readonly NamespaceID onlyCanCool = Get("only_can_cool");
