...
{
    [AutoEntityBehaviourDefinition(VanillaProjectileNames.KnifeBullet)]
    public class KnifeBullet : EntityBehaviourDefinition
    {
        public KnifeBullet(string nsp, string name) : base(nsp, name)
        {
