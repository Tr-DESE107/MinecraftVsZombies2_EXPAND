...
{
    [AutoEntityBehaviourDefinition(VanillaProjectileNames.AndesiteAlloySpike)]
    public class AndesiteAlloySpike : EntityBehaviourDefinition
    {
        public AndesiteAlloySpike(string nsp, string name) : base(nsp, name)
        {
