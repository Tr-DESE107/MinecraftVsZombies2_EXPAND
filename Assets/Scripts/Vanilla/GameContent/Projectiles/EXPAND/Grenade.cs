...
{
    [AutoEntityBehaviourDefinition(VanillaProjectileNames.Grenade)]
    public class Grenade : EntityBehaviourDefinition
    {
        public Grenade(string nsp, string name) : base(nsp, name)
        {
        }
