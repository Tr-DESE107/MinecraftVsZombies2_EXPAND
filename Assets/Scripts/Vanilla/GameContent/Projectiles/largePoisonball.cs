...
namespace MVZ2.GameContent.Projectiles
{
    ...
    public class LargePoisonball : ProjectileBehaviour
    {
        ...
        private void PostEnemyTakeDamageCallback(VanillaLevelCallbacks.PostTakeDamageParams param, CallbackResult result)
        {
            ...
            if (source == null)
                return;
            if (bodyResult.Fatal && source.IsEntityOf(VanillaProjectileID.largePoisonball))
            {
        ...
        protected override void PostHitEntity(ProjectileHitOutput hitResult, DamageOutput damage)
        {
            ...
            if (enemy.GetShellID() != VanillaShellID.flesh)
                return;
            enemy.InflictCorropoisonBuff(2f, 300, new EntitySourceReference(hitResult.Projectile));
        }
