...
{
    [AutoArmorBehaviourDefinition(VanillaArmorBehaviourNames.ChiefCannon)]
    public class ChiefCannon : ArmorBehaviourDefinition
    {
        public ChiefCannon(string nsp, string name) : base(nsp, name)
        {
        ...
        public override void PostUpdate(Armor armor)
        {
            ...
            if (timer.Expired)
            {
                ...
                owner.SpawnWithParams(VanillaEnemyID.PirateIMP, pos);
