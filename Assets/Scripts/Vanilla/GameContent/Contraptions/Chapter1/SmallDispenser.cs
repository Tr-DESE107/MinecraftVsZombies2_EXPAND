    ...
    public class SmallDispenser : DispenserFamily
    {
        ...
        protected override void UpdateAI(Entity entity)
        {
            ...
            if (cooldownTimer != null)
            {
                ...
                // 检测冷却结束，将 triggerCount 从 3 回归到 2  
                if (triggerCount == 3 && cooldownTimer.Expired)
                {
                    SetTriggerCount(entity, 2);
                    entity.SetModelProperty("triggerCount", 2);
        ...
        {
            entity.SetProperty(PROP_TRIGGER_COUNT, value); // 设置 Entity 属性，C# 逻辑获取
            entity.SetModelProperty("triggerCount", value); // 设置 Model 属性，用于贴图切换
        }
