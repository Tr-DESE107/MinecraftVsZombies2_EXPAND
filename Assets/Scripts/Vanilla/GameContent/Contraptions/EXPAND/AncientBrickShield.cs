...
{
    [AutoEntityBehaviourDefinition(VanillaContraptionNames.AncientBrickShield)]
    public class AncientBrickShield : ContraptionBehaviour
    {
        public AncientBrickShield(string nsp, string name) : base(nsp, name)
        {
