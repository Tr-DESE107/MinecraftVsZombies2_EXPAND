...
namespace MVZ2.GameContent.Contraptions
{
    ...
    public class Magichest : ContraptionBehaviour
    {
        ...
        public static void Eat(Entity entity, Entity target)
        {
            ...
            var input = new DamageInput(0, effects, target, new EntityReferenceChain(entity));
            target.Die(input);
                ...
                case VanillaEntityStates.MAGICHEST_LOMS:
                    {
                        ...
                        {
                            var ghast = entity.Level.Spawn(VanillaEnemyID.skeleton, entity.GetCenter(), entity);
