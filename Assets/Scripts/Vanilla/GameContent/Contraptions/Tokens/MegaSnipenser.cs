    ...
    public class MegaSnipenser : AIEntityBehaviour
    {
        ...
        public void Shoot(Entity entity)
        {
            ...
            for (int i = 0; i < spreadCount; i++)
            {
                ...
                if (proj != null && entity.GetProperty<bool>(PROP_BULLET_UPGRADED))
                {
                    if (proj.IsEntityOf(VanillaProjectileID.arrow)) proj.AddBuff<HellfireIgnitedBuff>();
                    else proj.AddBuff<ElectrifiedBuff>();
                }
            }
        }
        ...
        public static readonly VanillaEntityPropertyMeta<bool> PROP_BULLET_UPGRADED = new VanillaEntityPropertyMeta<bool>("bulletUpgraded");
        public static bool GetBulletUpgraded(Entity entity) => entity.GetBehaviourField<bool>(PROP_BULLET_UPGRADED);
        public static void SetBulletUpgraded(Entity entity, bool value) => entity.SetBehaviourField(PROP_BULLET_UPGRADED, value);
    }
}
