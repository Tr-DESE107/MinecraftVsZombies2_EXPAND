    ...
    public class EXPANDispenser_Dispenser : DispenserFamily
    {
        ...
        private void EvokedUpdate(Entity entity)
        {
            ...
            if (evocationTimer.PassedInterval(2))
            {
                ...
                // 每次发射有2/100概率重新触发大招  
                if (entity.RNG.Next(100) < 2)
                {
                    evocationTimer.Reset();
                    entity.PlaySound(VanillaSoundID.motor);
                    entity.Spawn(VanillaEffectID.evocationStar, entity.GetCenter());
                    return;
                }
            }
        ...
        public const int EVOCATION_TIME = 90;
