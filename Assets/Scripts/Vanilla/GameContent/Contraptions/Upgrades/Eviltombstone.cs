...
namespace MVZ2.GameContent.Contraptions
{
    ...
    public class Eviltombstone : ContraptionBehaviour
    {
        ...
        protected override void OnEvoke(Entity entity)
        {
            ...
            entity.SpawnWithParams(VanillaEnemyID.NetherArcher, pos)?.Let(arc =>
            {
                arc.AddBuff<NecrotombstoneRisingBuff>();
                arc.UpdateModel();
            });

            entity.SpawnWithParams(VanillaEnemyID.NetherVanguard, pos)?.Let(van =>
            {
                van.AddBuff<NecrotombstoneRisingBuff>();
                van.UpdateModel();
            });

            entity.SpawnWithParams(VanillaEnemyID.berserker, pos)?.Let(ber =>
            {
