...
namespace MVZ2.GameContent.Stages
{
    ...
    public class InfinitySeijaBehaviour : InfinityBossBehaviour
    {
        ...
        protected override int BossHealthStep => 969;
        protected override int BossHealthMax => 696969;
        ...
        protected override int BossHealthBonusPerChoice => 969; // 血量选项：每次增加的血量（默认= BossHealthStep）
