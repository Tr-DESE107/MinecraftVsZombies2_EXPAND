...
namespace MVZ2.GameContent.Stages
{
    ...
    {
        public WaveStageBehaviour(StageDefinition stageDef, bool hasBoss = false) : base(stageDef)
        {
        ...
        protected virtual void BossFinalWaveUpdate(LevelEngine level)
        {
        ...
        public int GetWaveMaxTime(LevelEngine level) => level.GetProperty<int>(VanillaStageProps.WAVE_MAX_TIME);
        public int GetWaveAdvanceTime(LevelEngine level) => level.GetProperty<int>(VanillaStageProps.WAVE_ADVANCE_TIME);
        ...
        public float GetWaveAdvanceHealthPercent(LevelEngine level) => level.GetProperty<float>(VanillaStageProps.WAVE_ADVANCE_HEALTH_PERCENT);
