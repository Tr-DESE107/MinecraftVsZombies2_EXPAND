...
namespace MVZ2.GameContent.Stages
{
    public class ConveyorStageBehaviour : StageBehaviour
    {
        ...
        #region 关卡属性
        public FrameTimer? GetConveyorTimer(LevelEngine level) => level.GetProperty<FrameTimer>(PROP_CONVEYOR_TIMER);
        public void SetConveyorTimer(LevelEngine level, FrameTimer value) => level.SetProperty(PROP_CONVEYOR_TIMER, value);
        #endregion
