...
namespace MVZ2.GameContent.Seeds
{
    public static class VanillaBlueprintNames
    {
        ...
        public const string HeavyWeaponContraptionSwap = "HeavyWeaponContraptionSwap";
        public const string HeavyWeaponBulletCount = "HeavyWeaponBulletCount";
    }
    public static class VanillaBlueprintID
    {
        ...
        public static readonly NamespaceID HeavyWeaponContraptionSwap = Get(VanillaBlueprintNames.HeavyWeaponContraptionSwap);
        public static readonly NamespaceID HeavyWeaponBulletCount = Get(VanillaBlueprintNames.HeavyWeaponBulletCount);
