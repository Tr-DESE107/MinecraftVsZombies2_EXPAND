...
{
    [EntityBehaviourDefinition(VanillaPickupNames.CopperIngot)]
    public class CopperIngot : PickupBehaviour
    {
        public CopperIngot(string nsp, string name) : base(nsp, name)
        {
