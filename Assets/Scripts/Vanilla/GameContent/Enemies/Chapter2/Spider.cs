...
namespace MVZ2.GameContent.Enemies
{
    ...
    public class Spider : AIEntityBehaviour
    {
        ...
        private static bool CanClimb(Entity enemy, Entity target)
        {
        ...
        public class Spider_Melee : EnemyMeleeBehaviour
        {
            public Spider_Melee(string nsp, string name) : base(nsp, name)
            {
            }
