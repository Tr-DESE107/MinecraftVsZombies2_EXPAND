...
namespace MVZ2.GameContent.Enemies
{
    ...
    public class AssaultDullahan : MeleeEnemy
    {
        ...
        public override void Init(Entity entity)
        {
            ...
            entity.Spawn(VanillaEnemyID.WitherSkeletonHorse, entity.Position, param)?.Let(horse =>
            {
                entity.RideOn(horse);
            });
        ...
        public static Entity? DropHead(Entity entity)
        {
            if (IsHeadDropped(entity))
                return null;
            var head = entity.SpawnWithParams(VanillaEnemyID.BerserkerHead, entity.GetCenter())?.Let(h =>
            {
                SetHead(entity, h);
                DullahanHead.SetBody(h, entity);
            });
