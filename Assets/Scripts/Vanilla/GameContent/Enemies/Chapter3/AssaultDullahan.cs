...
namespace MVZ2.GameContent.Enemies
{
    ...
    public class AssaultDullahan : AIEntityBehaviour, IDeathEffectsBehaviour
    {
        ...
        public static Entity? DropHead(Entity entity)
        {
            if (IsHeadDropped(entity))
                return null;
            var head = entity.SpawnWithParams(VanillaEnemyID.BerserkerHead, entity.GetCenter())?.Let(e =>
            {
                SetHead(entity, e);
