...
{
    [EntityBehaviourDefinition(VanillaEnemyNames.WitherSkeletonHorse)]
    public class WitherSkeletonHorse : MeleeEnemy
    {
        ...
        protected override void UpdateAI(Entity entity)
        {
            ...
            entity.SetProperty(PROP_SPEED_MULTIPLIER, entity.State == STATE_GALLOP ? 3f : 1.5f);
        ...
        private static readonly NamespaceID ID = VanillaEnemyID.WitherSkeletonHorse;
    }
}
