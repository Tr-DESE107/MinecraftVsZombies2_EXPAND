...
{
    [AutoEntityBehaviourDefinition(VanillaEnemyNames.WraithDullhan)]
    public class WraithDullhan : AIEntityBehaviour
    {
        public WraithDullhan(string nsp, string name) : base(nsp, name)
        {
        }
