...
{
    [AutoEntityBehaviourDefinition(VanillaEnemyNames.WraithArcher)]
    public class WraithArcher : AIEntityBehaviour
    {
        public WraithArcher(string nsp, string name) : base(nsp, name)
        {
        ...
        private static readonly NamespaceID ID = VanillaEnemyID.WraithArcher;
