...
{
    public abstract class ClickContraptionTargetHeldItemBehaviour : EntityHeldItemBehaviour, IHeldTwinkleEntityBehaviour
    {
        public ClickContraptionTargetHeldItemBehaviour(string nsp, string name) : base(nsp, name)
        {
        }
        ...
        protected abstract void OnUseOnGrid(HeldItemTargetGrid targetGrid, IHeldItemData data, PointerInteractionData pointerParams);
    }
}
