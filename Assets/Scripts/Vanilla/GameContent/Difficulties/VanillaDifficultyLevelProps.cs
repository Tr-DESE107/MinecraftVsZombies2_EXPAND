...
namespace MVZ2.GameContent.Difficulties
{
    ...
    public static class VanillaDifficultyLevelProps
    {
        ...
        // 无限Boss增强弹窗的选项数量上限（默认普通 4；简单 +1，困难/EXP -1，实际范围取 [上限-2, 上限]）。
        public static readonly VanillaDifficultyPropertyMeta<int> INFINITY_BOSS_UPGRADE_OPTION_COUNT = Get<int>("infinityBossUpgradeOptionCount", 4);
        ...
        public static int GetInfinityBossUpgradeOptionCount(this LevelEngine level) => level.GetProperty<int>(INFINITY_BOSS_UPGRADE_OPTION_COUNT);
