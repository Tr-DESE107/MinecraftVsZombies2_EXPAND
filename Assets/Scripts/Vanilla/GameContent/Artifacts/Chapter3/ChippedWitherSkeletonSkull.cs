...
{
    [AutoArtifactDefinition(VanillaArtifactNames.ChippedWitherSkeletonSkull)]
    public class ChippedWitherSkeletonSkull : ArtifactDefinition
    {
        public ChippedWitherSkeletonSkull(string nsp, string name) : base(nsp, name)
        {
        ...
        private void PostContraptionInitCallback(EntityCallbackParams param, CallbackResult result)
        {
            ...
            foreach (var artifact in artifacts)
            {
                ...
                if (artifact.Definition != this)
                    continue;
                artifact.Highlight();
                contraption.AddBuff<ChippedWitherSkeletonSkullReduceHealthBuff>();
            }
        }
        ...
        {
            public ReduceCostAura() : base(VanillaBuffID.SeedPack.ChippedWitherSkeletonSkullReduceCost, 4)
            {
            }
