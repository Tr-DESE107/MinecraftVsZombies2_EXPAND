...
{
    [BuffDefinition(VanillaBuffNames.SeedPack.witherSkeletonSkullReduceCost)]
    public class WitherSkeletonSkullReduceCostBuff : BuffDefinition
    {
        ...
        {
            AddModifier(new FloatModifier(EngineSeedProps.COST, NumberOperator.Multiply, 0.75f));
        }
    }
}
