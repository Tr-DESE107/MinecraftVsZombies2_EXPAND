...
namespace MVZ2.GameContent.Buffs.Enemies
{
    ...
    public class GravelOnFaceBuff : BuffDefinition
    {
        ...
        public override void PostUpdate(Buff buff)
        {
            ...
            if (entity != null && !entity.IsDead)
            {
                entity.TakeDamage(FRAME_DAMAGE, new DamageEffectList(VanillaDamageEffects.MUTE, VanillaDamageEffects.IGNORE_ARMOR), entity);
            }
        }
        ...
        public const float FRAME_DAMAGE = 0.5f;
        public const float DEFAULT_SECONDS = 6f;
