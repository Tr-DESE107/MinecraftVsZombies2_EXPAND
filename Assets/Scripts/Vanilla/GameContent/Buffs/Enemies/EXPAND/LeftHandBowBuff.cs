...
namespace MVZ2.GameContent.Buffs.Enemies
{
    ...
    public class LeftHandBowBuff : BuffDefinition
    {
        public LeftHandBowBuff(string nsp, string name) : base(nsp, name)
        {
            ...
            //���棺���˹����ٶȽ���
            AddModifier(new FloatModifier(VanillaEntityProps.ATTACK_SPEED, NumberOperator.Multiply, 99f));
        ...
        //    // ��ȡ��ʵ����������LeftHandBowBuffʵ��
        //    buffBuffer.Clear();
        //    entity.GetBuffs<LeftHandBowBuff>(buffBuffer);
