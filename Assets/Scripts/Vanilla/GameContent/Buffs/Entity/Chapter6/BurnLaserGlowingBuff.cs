...
namespace MVZ2.GameContent.Buffs.Entities
{
    ...
    [AutoBuffDefinition(VanillaBuffNames.Entity.BurnLaserGlowing)]
    public class BurnLaserGlowingBuff : BuffDefinition
    {
        public BurnLaserGlowingBuff(string nsp, string name) : base(nsp, name)
        {
