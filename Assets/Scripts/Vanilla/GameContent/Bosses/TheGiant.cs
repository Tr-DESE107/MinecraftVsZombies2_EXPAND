...
namespace MVZ2.GameContent.Bosses
{
    ...
    public partial class TheGiant : BossBehaviour
    {
        ...
        public const int STATE_DISASSEMBLY = VanillaBossStates.THE_GIANT_DISASSEMBLY;
        public const int STATE_EYES = VanillaBossStates.THE_GIANT_EYES;
        public const int STATE_ROAR = VanillaBossStates.THE_GIANT_ROAR;
        public const int STATE_ARMS = VanillaBossStates.THE_GIANT_ARMS;
        public const int STATE_BREATH = VanillaBossStates.THE_GIANT_BREATH;
        public const int STATE_PACMAN = VanillaBossStates.THE_GIANT_PACMAN;
        public const int STATE_SNAKE = VanillaBossStates.THE_GIANT_SNAKE;
        public const int STATE_FAINT = VanillaBossStates.THE_GIANT_FAINT;
        public const int STATE_CHASE = VanillaBossStates.THE_GIANT_CHASE;
