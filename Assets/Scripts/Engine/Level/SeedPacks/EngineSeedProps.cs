...
namespace PVZEngine.Level
{
    ...
    public static class EngineSeedProps
    {
        ...
        public static readonly PropertyMeta<float> TRIGGER_COST = Get<float>("triggerCost");
        ...
        public static float GetTriggerCost(this SeedDefinition definition)
        {
            return definition.GetProperty<float>(TRIGGER_COST);
        }
