...
namespace PVZEngine.Level
{
    public partial class LevelEngine
    {
        ...
        {
            seri.conveyorSeedPacks = conveyorSeedPacks.Select(s => s != null ? s.Serialize() : null).ToArray();
        ...
        public void CreateConveyorFromSerializable(SerializableLevel seri)
        {
            ...
            conveyorSeedPacks = seri.conveyorSeedPacks.Select(s => s != null ? ConveyorSeedPack.Deserialize(s, this) : null).ToList();
        }
